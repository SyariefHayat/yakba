...
const MitraHero = () => {
    ...
    return (
        <section className="w-full min-h-[55vh] flex flex-col items-center justify-center bg-[#FFD502] overflow-hidden relative px-6 py-24 md:py-28">
            ...
            <Star delay={1.0} className="top-[20%] left-[10%] md:top-[22%] md:left-[18%]" />
            <Star delay={1.7} className="top-[18%] right-[12%] md:top-[16%] md:right-[16%]" />
            <Star delay={2.3} className="bottom-[30%] right-[8%] md:bottom-[26%] md:right-[20%]" />
            ...
            <div className="relative z-20 flex flex-col items-center text-center max-w-3xl mx-auto">
                ...
                <p
                    ...
                    style={{ opacity: 0 }}
                >
                    Bergabung sebagai mitra guru dan buka kelompok bimbingan belajar
                    Yakba di daerahmu. Bersama kita ciptakan generasi yang cerdas dan berkarakter.
                </p>
            </div>
