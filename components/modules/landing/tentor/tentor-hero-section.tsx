        ...
        <section className="relative w-full h-[30vh] lg:h-[50vh] bg-sky-100 overflow-hidden">
            ...
            >
                ...
                <p className="-mt-1 md:mt-0 text-lg md:text-2xl">
                    <span style={{ color: COLORS.green }}>Guru </span>
                    <span style={{ color: COLORS.pink }}>Profesional </span>
                    <span style={{ color: COLORS.blue }}>& Berpengalaman</span>
                </p>
            </div>
...
export default TentorHeroSection
