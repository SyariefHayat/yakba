...
const ProductDetailHero = () => {
    ...
    return (
        <section className="relative w-full h-[30vh] lg:h-[50vh] bg-sky-100 overflow-hidden">
            ...
            >
                <p className="md:mb-2">Detail Produk</p>
                ...
                <p className="-mt-1 md:mt-0 text-lg md:text-2xl">
                    <span style={{ color: COLORS.green }}>Koleksi </span>
                    <span style={{ color: COLORS.pink }}>Produk </span>
                    <span style={{ color: COLORS.blue }}>Kami</span>
                </p>
            </div>
