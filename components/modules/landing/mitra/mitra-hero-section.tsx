...
const MitraHeroSection = () => {
    ...
    return (
        <section className="relative w-full h-[30vh] lg:h-[50vh] bg-sky-100 overflow-hidden">
            ...
            >
                <p className="md:mb-2">Peluang Usaha</p>
                ...
                <p className="-mt-1 md:mt-0 text-lg md:text-2xl">
                    <span style={{ color: COLORS.green }}>Bergabung </span>
                    <span style={{ color: COLORS.pink }}>& </span>
                    <span style={{ color: COLORS.blue }}>Berkembang Bersama</span>
                </p>
            </div>
...
export default MitraHeroSection
