...
const ContactHeroSection = () => {
    ...
    return (
        <section className="relative w-full h-[30vh] lg:h-[50vh] bg-sky-100 overflow-hidden">
            ...
            >
                <p className="md:mb-2">Hubungi Kami</p>
                ...
                <p className="-mt-1 md:mt-0 text-lg md:text-2xl">
                    <span style={{ color: COLORS.green }}>Kami </span>
                    <span style={{ color: COLORS.pink }}>Siap </span>
                    <span style={{ color: COLORS.blue }}>Membantu Anda</span>
                </p>
            </div>
