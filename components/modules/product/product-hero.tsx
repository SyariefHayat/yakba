...
const ProductHero = () => {
    ...
    return (
        <section className="w-full min-h-[55vh] flex flex-col items-center justify-center bg-[#FFD502] overflow-hidden relative px-6 py-24 md:py-28">
            ...
            <Star
                delay={1.0}
                className="top-[18%] left-[8%] md:top-[22%] md:left-[18%]"
            />
            <Star
                delay={1.8}
                className="top-[22%] right-[10%] md:top-[18%] md:right-[15%]"
            />
            <Star
                delay={2.4}
                className="bottom-[30%] right-[15%] md:bottom-[28%] md:right-[22%]"
            />
            ...
            <div className="relative z-20 flex flex-col items-center text-center max-w-3xl mx-auto">
                ...
                <p
                    ...
                    style={{ opacity: 0 }}
                >
                    Koleksi produk digital dan fisik yang dirancang khusus untuk mendukung
                    proses belajar anak dengan cara yang menyenangkan.
                </p>
            </div>
