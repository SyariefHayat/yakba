...
const HeroSection = () => {
  return (
    <section className="w-full min-h-screen flex flex-col items-center justify-center bg-[#FFD502] overflow-hidden relative">
      ...
      <Circle className="absolute w-[50vw] md:w-[25vw] lg:w-[14vw] top-[15%] md:top-[20%] lg:top-[16%] left-[33%] md:left-[38%] lg:left-[40%]" />

      <Tree
        side="left"
        size="sm"
        className="absolute w-[25vw] md:w-[18vw] lg:hidden top-[35%] left-5 md:top-[30%] md:left-[1%]"
      />
      <Tree
        side="right"
        size="sm"
        className="absolute w-[25vw] md:w-[18vw] top-[35%] right-5 md:top-[22%] md:right-[1%] lg:top-[13%] lg:right-[4%]"
      />

      <Star
        delay={1.2}
        className="top-[15%] left-[30%] md:top-[40.5%] lg:top-[50%] lg:left-[12%]"
      />
      <Star
        delay={1.8}
        className="top-[28%] left-[8%] md:top-[25%] md:left-[25%] lg:top-[29%] lg:left-[30%]"
      />
      <Star
        delay={2.4}
        className="top-[24%] right-[12%] md:top-[20%] md:right-[10%] lg:top-[40%] lg:right-[17%]"
      />

      <div className="w-full flex items-center justify-center lg:justify-between mt-32 md:mt-20">
        <RightLine />
        <Text />
        <LeftLine />
      </div>

      <Pool className="absolute w-[43vw] md:w-[82vw] lg:w-[42vw] bottom-[12%] md:bottom-[18%] lg:bottom-[2%] left-0" />

      <Grass
        delay={1.5}
        skewAmount={15}
        className="absolute cursor-pointer w-[12vw] md:w-[10vw] lg:w-[6vw] bottom-[24%] left-[65%] md:bottom-[18%] md:left-[40%] lg:bottom-[8%] lg:left-[15%]"
      />
      <Grass
        delay={1.8}
        skewAmount={12}
        className="absolute cursor-pointer w-[12vw] md:w-[10vw] lg:w-[6vw] bottom-[20%] right-[5%] md:bottom-[23%] md:right-[4%] lg:bottom-[10%] lg:right-[15%]"
      />
      <Grass
        delay={2.1}
        skewAmount={18}
        className="absolute cursor-pointer w-[12vw] md:w-[10vw] lg:w-[6vw] bottom-[16%] right-[30%] lg:bottom-[18%] lg:right-[8%]"
      />

      <Ellipse
        className="absolute w-[80vw] md:w-[95vw] lg:w-[74vw]
